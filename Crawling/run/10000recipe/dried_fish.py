...
# 소고기 돼지고기 닭고기 육류 채소류 해물류 달걀/유제품 가공식품류 쌀 밀가루 건어물류 버섯류 과일류 공/견과류 곡류 기타
crawler = Crawler_10000recipe(cartagory='건어물류')

tree_manager = TreeManager("10000recipe_dried_fish", crawler)
